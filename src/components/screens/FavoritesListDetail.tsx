  ...
  return (
    <div>
      <div className={styles.header}>
        <button type="button" className={styles.circleButton} onClick={actions.backToLists} aria-label="Retour">
      ...
      <div className={styles.content}>
        {curListItems.length > 0 ? (
          ...
          <div className={styles.empty}>
            ...
            <div className={styles.emptyTitle}>Liste vide</div>
            <div className={styles.emptyHint}>
              Ouvrez une fiche et touchez le cœur pour ajouter un fromage à cette liste.
            </div>
          </div>
        )}
      </div>
